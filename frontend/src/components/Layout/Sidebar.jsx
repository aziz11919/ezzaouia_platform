...
const adminSection = {
  ...
  items: [
    ...
    },
    {
      ...
      icon: (
        <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11.25 3.75a.75.75 0 011.5 0V6a.75.75 0 01-1.5 0V3.75zM4.72 6.28a.75.75 0 011.06 0l1.59 1.59a.75.75 0 11-1.06 1.06L4.72 7.34a.75.75 0 010-1.06zM3.75 11.25H6a.75.75 0 010 1.5H3.75a.75.75 0 010-1.5zM6.31 15.07a.75.75 0 011.06 1.06l-1.59 1.59a.75.75 0 01-1.06-1.06l1.59-1.59zM11.25 18a.75.75 0 011.5 0v2.25a.75.75 0 01-1.5 0V18zM16.63 16.13a.75.75 0 111.06-1.06l1.59 1.59a.75.75 0 11-1.06 1.06l-1.59-1.59zM18 11.25h2.25a.75.75 0 010 1.5H18a.75.75 0 010-1.5zM16.63 7.87a.75.75 0 011.06-1.06l1.59 1.59a.75.75 0 11-1.06 1.06l-1.59-1.59zM12 8.25A3.75 3.75 0 1012 15.75 3.75 3.75 0 0012 8.25z" />
        </svg>
      ),
    },
  ],
...
export default function Sidebar() {
  ...
  return (
    <aside className="sidebar" style={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
      ...
      {/* Scrollable top: logo + status + nav */}
      ...
      {/* Fixed bottom: avatar + profile + logout */}
        ...
        <Link to="/profile" style={{ textDecoration: 'none' }}>
          <div className="user-info" style={{ marginBottom: 10 }}>
            ...
            <div>
              ...
              <span className={`role-badge role-${role}`}>{role === 'admin' ? 'ADMIN' : 'USER'}</span>
            </div>
          </div>
        </Link>
